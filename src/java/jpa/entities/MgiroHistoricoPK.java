 ...
 */
@Embeddable
public class MgiroHistoricoPK implements Serializable {
    ...
    public MgiroHistoricoPK() {
    }

    public MgiroHistoricoPK(int folioGiro, String sucRemite) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof MgiroHistoricoPK)) {
            return false;
        }
        MgiroHistoricoPK other = (MgiroHistoricoPK) object;
    ...
    public String toString() {
        return "jpa.entities.MgiroHistoricoPK[ folioGiro=" + folioGiro + ", sucRemite=" + sucRemite + " ]";
    }
