...
import jpa.session.AuditoriaFacade;
...
public class AuditoriaController implements Serializable {
    ...
    @EJB
    private jpa.session.AuditoriaFacade ejbFacade;
    ...
    public static class AuditoriaControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Auditoria) {
                ...
                return getStringKey(o.getAudCodigo());
            } else {
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + AuditoriaController.class.getName());
            }
        }
    }
}
